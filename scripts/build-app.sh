...
# The autogenerated Swift package scheme enables coverage for the build action.
# Packaged apps must not emit default.profraw files when users launch them.
"$XCODEBUILD" \
    -scheme "$SCHEME" \
    ...
    SWIFTC_CLANG_COVERAGE_MAPPING_LINKER_ARGS=NO \
    build
