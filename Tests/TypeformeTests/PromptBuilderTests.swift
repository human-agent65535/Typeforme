...
struct PromptBuilderTests {
    ...
    @Test func builtInPromptsFavorDirectCommitAndSemanticASRCorrections() {
        ...
        #expect(base.contains("cancellations remove canceled item/action"))
        ...
        #expect(clean.count < 800)
        #expect(clean.contains("Lossless cleanup of the final intended text"))
        #expect(clean.contains("Remove meaningless filler and filler-only repetition"))
        #expect(clean.contains("Collapse only explicit local repairs"))
        #expect(clean.contains("Keep wording, order, tone, register, uncertainty, repeated content words"))
        #expect(clean.contains("Repeated negation"))
        #expect(clean.contains("must stay repeated"))
        #expect(clean.contains("Do not rewrite"))

        let polishPlus = BuiltInPrompts.modePrompt(.polishPlus)
        #expect(polishPlus.count < 1_400)
        #expect(polishPlus.contains("Natural rewrite of the user's final intended text"))
        ...
        #expect(polishPlus.contains("prefer the post-update list"))
        #expect(polishPlus.contains("keep update wording when the user is discussing the change itself"))
        #expect(polishPlus.contains("Keep the user's tone, register, language mix"))
        ...
        #expect(structurePlus.count < 900)
        #expect(structurePlus.contains("Structured rewrite of the user's final intended text"))
        ...
        #expect(structurePlus.contains("preserve every final fact, qualifier, language mix"))
        ...
        #expect(formalPlus.count < 900)
        #expect(formalPlus.contains("Professional rewrite of the user's final intended text"))
        #expect(formalPlus.contains("output the final state, not repair phrases"))
        #expect(formalPlus.contains("make surrounding prose concise and professional"))
        #expect(formalPlus.contains("Do not translate technical/team tokens"))
        #expect(formalPlus.contains("add courtesy, add business context"))
